...
void adminMenu(User* u, vector<User>& users) {
    while (true) {
        clearScreen();
        // Hiển thị menu quản trị với các nhóm chức năng
        cout << "\n"
            
             << "1. Change Password       2. List Users\n";
        cout << "3. Create Admin          4. Edit User\n";
        cout << "5. View User Info        6. Transfer Points\n";
        cout << "7. Delete User           0. Logout\n";
        cout << "Choice: ";
        int c;
        cin >> c;
        cin.ignore(numeric_limits<streamsize>::max(), '\n');
        switch (c) {
        case 1:
            // Admin tự đổi mật khẩu của chính mình
            changePassword(u, users);
            break;
        case 2:
            cout << "\n--- User List ---\n";
